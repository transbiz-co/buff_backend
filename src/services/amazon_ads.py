    ...
    def _get_report_columns(self, ad_product: str) -> List[str]:
        ...
        match ad_product:
            ...
            case "SPONSORED_DISPLAY":
                return [
                    "viewabilityRate","offAmazonSignUpValueSum","addToListFromViews","offAmazonLeadsClicks","offAmazonCheckoutClicks",
                    "unitsSold","offAmazonApplicationsViews","offAmazonSubscribeClicks","qualifiedBorrowsFromViews",
                    "offAmazonApplications","addToListFromClicks","viewClickThroughRate","offAmazonLeadValueAverage","offAmazonERPM",
                    "campaignId","offAmazonContacts","offAmazonLeadValueSum","offAmazonSearchValueAverage","offAmazonApplicationValueAverage",
                    "offAmazonROAS","offAmazonOtherClicks","offAmazonSignUpValueAverage","leadFormOpens","campaignBudgetCurrencyCode",
                    "offAmazonAddToCartValueSum","offAmazonSearchClicks","videoCompleteViews","offAmazonAddToCart","impressionsViews",
                    "offAmazonSubscribeViews","salesClicks","videoFirstQuartileViews","offAmazonAddToCartViews","offAmazonOtherValueAverage",
                    "brandedSearches","offAmazonSearch","longTermSales","offAmazonSubscribeValueSum","offAmazonCheckoutValueAverage",
                    "offAmazonContactValueAverage","addToCart","offAmazonPurchasesClicks","videoThirdQuartileViews","offAmazonContactClicks",
                    "addToCartRate","offAmazonUnitsSold","offAmazonPageViewValueSum","salesPromotedClicks","offAmazonAddToCartClicks","impressions",
                    "offAmazonSubscribe","detailPageViewsClicks","purchasesPromotedClicks","offAmazonSearchViews","eCPAddToCart","videoMidpointViews",
                    "newToBrandUnitsSoldClicks","offAmazonPageViewValueAverage","date","newToBrandSalesClicks","offAmazonAddToCartValueAverage",
                    "purchasesClicks","offAmazonCheckoutValueSum","detailPageViews","offAmazonOtherValueSum","addToCartViews","sales",
                    "qualifiedBorrowsFromClicks","offAmazonApplicationsClicks","offAmazonPurchases","offAmazonSignUpClicks",
                    "royaltyQualifiedBorrowsFromClicks","royaltyQualifiedBorrowsFromViews","offAmazonCheckouts","purchases","offAmazonLeads",
                    "offAmazonContactValueSum","offAmazonSignUp","offAmazonOtherViews","qualifiedBorrows","longTermROAS","offAmazonOther",
                    "offAmazonSignUpViews","offAmazonCheckoutViews","leads","offAmazonClicks","offAmazonProductSales","offAmazonApplicationValueSum",
                    "unitsSoldClicks","royaltyQualifiedBorrows","offAmazonPageViewClicks","newToBrandPurchases","brandedSearchesClicks","brandedSearchRate",
                    "addToList","linkOuts","newToBrandPurchasesClicks","brandedSearchesViews","addToCartClicks","videoUnmutes","offAmazonPageViews",
                    "cost","offAmazonPageViewViews","offAmazonConversions","offAmazonPurchasesViews","offAmazonLeadsViews","eCPBrandSearch",
                    "newToBrandUnitsSold","offAmazonViews","offAmazonSubscribeValueAverage","offAmazonContactViews","offAmazonSearchValueSum","clicks",
                    "campaignName","newToBrandSales","newToBrandDetailPageViewRate","impressionsFrequencyAverage","newToBrandDetailPageViewViews",
                    "newToBrandDetailPageViewClicks","costType","newToBrandDetailPageViews","campaignStatus",
                    "newToBrandECPDetailPageView","cumulativeReach","campaignBudgetAmount"
                ]
            case _:
                return []
                                    ...
                                    if existing_report.data:
                                        ...
                                        report_record = {
                                            ...
                                            "configuration": {
                                                ...
                                                "groupBy": ["campaign"],
                                                "columns": self._get_report_columns(ad_product),
                                                "reportTypeId": self._get_report_type_id(ad_product),
                                                "timeUnit": "DAILY",
                                                "format": "GZIP_JSON"
                                            },
                                            "created_at": datetime.now().isoformat(),
